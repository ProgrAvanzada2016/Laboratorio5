...
${OBJECTDIR}/conceptos/aceptaCargo.o: conceptos/aceptaCargo.cpp 
	${MKDIR} -p ${OBJECTDIR}/conceptos
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conceptos/aceptaCargo.o conceptos/aceptaCargo.cpp

${OBJECTDIR}/conceptos/aprobacion.o: conceptos/aprobacion.cpp 
	${MKDIR} -p ${OBJECTDIR}/conceptos
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conceptos/aprobacion.o conceptos/aprobacion.cpp

${OBJECTDIR}/conceptos/asignatura.o: conceptos/asignatura.cpp 
	${MKDIR} -p ${OBJECTDIR}/conceptos
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conceptos/asignatura.o conceptos/asignatura.cpp

${OBJECTDIR}/conceptos/carrera.o: conceptos/carrera.cpp 
	${MKDIR} -p ${OBJECTDIR}/conceptos
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conceptos/carrera.o conceptos/carrera.cpp

${OBJECTDIR}/conceptos/date.o: conceptos/date.cpp 
	${MKDIR} -p ${OBJECTDIR}/conceptos
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conceptos/date.o conceptos/date.cpp

${OBJECTDIR}/conceptos/empresa.o: conceptos/empresa.cpp 
	${MKDIR} -p ${OBJECTDIR}/conceptos
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conceptos/empresa.o conceptos/empresa.cpp

${OBJECTDIR}/conceptos/encargado.o: conceptos/encargado.cpp 
	${MKDIR} -p ${OBJECTDIR}/conceptos
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conceptos/encargado.o conceptos/encargado.cpp

${OBJECTDIR}/conceptos/inscripcion.o: conceptos/inscripcion.cpp 
	${MKDIR} -p ${OBJECTDIR}/conceptos
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conceptos/inscripcion.o conceptos/inscripcion.cpp

${OBJECTDIR}/conceptos/oferta.o: conceptos/oferta.cpp 
	${MKDIR} -p ${OBJECTDIR}/conceptos
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conceptos/oferta.o conceptos/oferta.cpp
...
${OBJECTDIR}/conceptos/seccion.o: conceptos/seccion.cpp 
	${MKDIR} -p ${OBJECTDIR}/conceptos
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conceptos/seccion.o conceptos/seccion.cpp

${OBJECTDIR}/conceptos/sucursal.o: conceptos/sucursal.cpp 
	${MKDIR} -p ${OBJECTDIR}/conceptos
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conceptos/sucursal.o conceptos/sucursal.cpp

${OBJECTDIR}/controladores/ControladorEstudiante.o: controladores/ControladorEstudiante.cpp 
	${MKDIR} -p ${OBJECTDIR}/controladores
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controladores/ControladorEstudiante.o controladores/ControladorEstudiante.cpp

${OBJECTDIR}/controladores/ControladorOferta.o: controladores/ControladorOferta.cpp 
	${MKDIR} -p ${OBJECTDIR}/controladores
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controladores/ControladorOferta.o controladores/ControladorOferta.cpp
...
${OBJECTDIR}/datatypes/dtAcepto.o: datatypes/dtAcepto.cpp 
	${MKDIR} -p ${OBJECTDIR}/datatypes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datatypes/dtAcepto.o datatypes/dtAcepto.cpp

${OBJECTDIR}/datatypes/dtAsignatura.o: datatypes/dtAsignatura.cpp 
	${MKDIR} -p ${OBJECTDIR}/datatypes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datatypes/dtAsignatura.o datatypes/dtAsignatura.cpp

${OBJECTDIR}/datatypes/dtEmpresa.o: datatypes/dtEmpresa.cpp 
	${MKDIR} -p ${OBJECTDIR}/datatypes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datatypes/dtEmpresa.o datatypes/dtEmpresa.cpp

${OBJECTDIR}/datatypes/dtEstudianteInfo.o: datatypes/dtEstudianteInfo.cpp 
	${MKDIR} -p ${OBJECTDIR}/datatypes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datatypes/dtEstudianteInfo.o datatypes/dtEstudianteInfo.cpp

${OBJECTDIR}/datatypes/dtLlamado.o: datatypes/dtLlamado.cpp 
	${MKDIR} -p ${OBJECTDIR}/datatypes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datatypes/dtLlamado.o datatypes/dtLlamado.cpp

${OBJECTDIR}/datatypes/dtOferta.o: datatypes/dtOferta.cpp 
	${MKDIR} -p ${OBJECTDIR}/datatypes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datatypes/dtOferta.o datatypes/dtOferta.cpp

${OBJECTDIR}/datatypes/dtRango.o: datatypes/dtRango.cpp 
	${MKDIR} -p ${OBJECTDIR}/datatypes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datatypes/dtRango.o datatypes/dtRango.cpp
...
${OBJECTDIR}/manejadores/ManejadorEstudiante.o: manejadores/ManejadorEstudiante.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/manejadores/ManejadorEstudiante.o manejadores/ManejadorEstudiante.cpp

${OBJECTDIR}/manejadores/ManejadorOferta.o: manejadores/ManejadorOferta.cpp 
	${MKDIR} -p ${OBJECTDIR}/manejadores
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/manejadores/ManejadorOferta.o manejadores/ManejadorOferta.cpp
